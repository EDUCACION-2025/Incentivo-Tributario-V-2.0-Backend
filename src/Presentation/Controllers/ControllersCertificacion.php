...
class ControllersCertificacion {
    ...
    public function observable__axios__recibidos_certificacion($post){
      ...
      if(intval($post["fisicamenteEstructura"])===43){

        return $this->constructor->select__general__incentivo("(SELECT a.id,a.codigo AS codigoUsuario,b.ruc,b.razonSocial,b.regimen, a.numeroFactura,a.fechaEmision,a.subotal,a.iva,a.total,a.ivaPorcentaje,a.tipoComprobante,a.gastoRealizar,a.idIncremental,a.fecha,a.hora,c.codigo AS codigoProyecto,d.nombre AS nombreProyecto,IF(a.version1 IS NULL,'NO','SI') AS version FROM proyecto_certificacion_factura_tramite AS a INNER JOIN certificacion_patrocinadores AS b ON a.idPatrocinador=b.id INNER JOIN proyecto_enviado AS c ON c.codigoUsuario=a.codigo INNER JOIN proyecto_descripcion AS d ON d.codigo=a.codigo WHERE estadoRevision IS NULL AND estadoRecomendacion IS NULL AND EXISTS(SELECT a1.id FROM proyecto_sector AS a1 WHERE (a1.idSector='4' OR a1.idSector='5') AND a1.codigo=a.codigo)) UNION (SELECT a.id,a.codigo AS codigoUsuario,b.ruc,b.razonSocial,b.regimen, a.numeroFactura,a.fechaEmision,a.subotal,a.iva,a.total,a.ivaPorcentaje,a.tipoComprobante,a.gastoRealizar,a.idIncremental,a.fecha,a.hora,c.codigo AS codigoProyecto,REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(c.nombre, 'Ã¡', 'á'),'Ã©','é'),'Ã­','í'),'Ã³','ó'),'Ãº','ú'),'Ã‰','É'),'ÃŒ','Í'),'Ã“','Ó'),'Ãš','Ú'),'Ã±','ñ'),'Ã‘','Ñ'),'&#039;',' ` '),'Ã','Á'),'',' '),'Ã','Á'),'SI','SI'),'â€œ',''),'â€',''),'Á²','ó')  AS nombreProyecto,IF(a.version1 IS NULL,'NO','SI') AS version FROM proyecto_certificacion_factura_tramite AS a INNER JOIN certificacion_patrocinadores AS b ON a.idPatrocinador=b.id INNER JOIN ezonshar_mdepsaddb.pro_proyecto AS c ON c.codigo=a.codigo WHERE (c.tipoDeportistas='actividadFisica' OR c.tipoDeportistas='recreativo' OR c.tipoDeportistas='estudiantil' OR c.tipoDeportistas='instalaciones')  AND estadoRevision IS NULL AND estadoRecomendacion IS NULL) UNION (SELECT a.id,a.codigo AS codigoUsuario,b.ruc,b.razonSocial,b.regimen, a.numeroFactura,a.fechaEmision,a.subotal,a.iva,a.total,a.ivaPorcentaje,a.tipoComprobante,a.gastoRealizar,a.idIncremental,a.fecha,a.hora,c.codigo AS codigoProyecto,d.nombre AS nombreProyecto,IF(a.version1 IS NULL,'NO','SI') AS version FROM proyecto_certificacion_factura_tramite AS a INNER JOIN certificacion_patrocinadores AS b ON a.idPatrocinador=b.id INNER JOIN proyecto_enviado AS c ON c.codigoUsuario=a.codigo INNER JOIN proyecto_descripcion AS d ON d.codigo=a.codigo WHERE estadoRevision IS NULL AND estadoRecomendacion IS NULL AND NOT EXISTS(SELECT a1.id FROM proyecto_sector AS a1 WHERE a1.codigo=a.codigo LIMIT 1) AND EXISTS (SELECT a1.idComponentesProyecto FROM proyecto_componente_usuario AS a1 WHERE a1.codigo=a.codigo AND a1.idComponentes='5' LIMIT 1));");

      }else if(intval($post["fisicamenteEstructura"])===40){

        return $this->constructor->select__general__incentivo("(SELECT a.id,a.codigo AS codigoUsuario,b.ruc,b.razonSocial,b.regimen, a.numeroFactura,a.fechaEmision,a.subotal,a.iva,a.total,a.ivaPorcentaje,a.tipoComprobante,a.gastoRealizar,a.idIncremental,a.fecha,a.hora,c.codigo AS codigoProyecto,d.nombre AS nombreProyecto,IF(a.version1 IS NULL,'NO','SI') AS version FROM proyecto_certificacion_factura_tramite AS a INNER JOIN certificacion_patrocinadores AS b ON a.idPatrocinador=b.id INNER JOIN proyecto_enviado AS c ON c.codigoUsuario=a.codigo INNER JOIN proyecto_descripcion AS d ON d.codigo=a.codigo WHERE estadoRevision IS NULL AND estadoRecomendacion IS NULL AND EXISTS(SELECT a1.id FROM proyecto_sector AS a1 WHERE (a1.idSector='1' OR a1.idSector='2' OR a1.idSector='3') AND a1.codigo=a.codigo)) UNION (SELECT a.id,a.codigo AS codigoUsuario,b.ruc,b.razonSocial,b.regimen, a.numeroFactura,a.fechaEmision,a.subotal,a.iva,a.total,a.ivaPorcentaje,a.tipoComprobante,a.gastoRealizar,a.idIncremental,a.fecha,a.hora,c.codigo AS codigoProyecto,REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(c.nombre, 'Ã¡', 'á'),'Ã©','é'),'Ã­','í'),'Ã³','ó'),'Ãº','ú'),'Ã‰','É'),'ÃŒ','Í'),'Ã“','Ó'),'Ãš','Ú'),'Ã±','ñ'),'Ã‘','Ñ'),'&#039;',' ` '),'Ã','Á'),'',' '),'Ã','Á'),'SI','SI'),'â€œ',''),'â€',''),'Á²','ó')  AS nombreProyecto,IF(a.version1 IS NULL,'NO','SI') AS version FROM proyecto_certificacion_factura_tramite AS a INNER JOIN certificacion_patrocinadores AS b ON a.idPatrocinador=b.id INNER JOIN ezonshar_mdepsaddb.pro_proyecto AS c ON c.codigo=a.codigo WHERE (c.tipoDeportistas='alto' OR c.tipoDeportistas='alto2' OR c.tipoDeportistas='altoRendimiento' OR c.tipoDeportistas='altoRendimientoDiscapacidad' OR c.tipoDeportistas='CompraVenta' OR c.tipoDeportistas='formativo' OR c.tipoDeportistas='profesional' OR c.tipoDeportistas='instalaciones')  AND estadoRevision IS NULL AND estadoRecomendacion IS NULL) UNION (SELECT a.id,a.codigo AS codigoUsuario,b.ruc,b.razonSocial,b.regimen, a.numeroFactura,a.fechaEmision,a.subotal,a.iva,a.total,a.ivaPorcentaje,a.tipoComprobante,a.gastoRealizar,a.idIncremental,a.fecha,a.hora,c.codigo AS codigoProyecto,d.nombre AS nombreProyecto,IF(a.version1 IS NULL,'NO','SI') AS version FROM proyecto_certificacion_factura_tramite AS a INNER JOIN certificacion_patrocinadores AS b ON a.idPatrocinador=b.id INNER JOIN proyecto_enviado AS c ON c.codigoUsuario=a.codigo INNER JOIN proyecto_descripcion AS d ON d.codigo=a.codigo WHERE estadoRevision IS NULL AND estadoRecomendacion IS NULL AND NOT EXISTS(SELECT a1.id FROM proyecto_sector AS a1 WHERE a1.codigo=a.codigo LIMIT 1) AND EXISTS (SELECT a1.idComponentesProyecto FROM proyecto_componente_usuario AS a1 WHERE a1.codigo=a.codigo AND a1.idComponentes='5' LIMIT 1));");
