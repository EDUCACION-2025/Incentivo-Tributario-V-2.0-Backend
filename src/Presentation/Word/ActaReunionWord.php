...
namespace App\Presentation\Word;

use App\Domain\Services\ServicesAdmin;



class ActaReunionWord {
    ...
    public static function getInstance() {
        if (self::$instance === null) {
            self::$instance = new ActaReunionWord();
        }
      ...
      $htm.= "
          ...
          <thead>
            ...
            <tr>
              ...
              <td class='font-bold small-column font-size-8px' align='center'>FIRMA </td>
        ...
        foreach ($array as $valor) {
          ...
          $htm.="
            ...
            <tr>
              ...
              <td class='small-column font-size-8px w-50'></td>
        ...
        $htm.= "
          ...
          <tr>
            ...
            <td class='font-bold small-column font-bold' align='center' colspan='3'>Secretaría de comité</td>
